...
let
  py2hwsw_commit = "054b6e779f078eaa9db4bb43cece16f83adac709"; # Replace with the desired commit.
  py2hwsw_sha256 = "sha256-6n1+nCYrFeAT63+ltpldFiIJdM4y1wQgvD0QjOV8W4Y="; # Replace with the actual SHA256 hash.
